...
nvcc -c -o diamond_stencil.o diamond_stencil.cu --ptxas-options=-v -std=c++14 -arch=sm_60 -I$atlasInc -I$eckitInc -L$atlasLib -latlas -L$eckitLib -leckit -I$atlasUtilsInc
